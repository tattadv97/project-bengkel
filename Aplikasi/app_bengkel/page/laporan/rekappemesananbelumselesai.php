...
<table border="1" width="100%" style="border-collapse: collapse;">
	...
	<caption>Laporan Daftar Pemesanan Belum Selesai Periode: <b><?php echo $_POST['tgl_awal']?></b> s/d <b><?php echo $_POST['tgl_akhir']?></b>
		<?php
	...
	<tbody>
		<?php
	        ...
	        $no=1;
	        $sql= $koneksi->query("select id_pemesanan,namalengkap,tb_pelanggan.alamat,tb_pelanggan.telp,nama_service,tgl_pesan,tgl_service, jam_service,status_pesan from tb_pemesanan,tb_service,tb_pelanggan where status_pesan!='Selesai Service' and
